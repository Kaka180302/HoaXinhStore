(function () {
    ...
    function renderProducts(products) {
        ...
        const html = products.map((product) => {
            ...
            const desc = getFieldValue(product, ["mota", "description", "desc"]);
            ...
            return `
                    ...
                    >
                        <div class="product_imgWrap">
                            <img
                                src="${escapeHtml(image || "https://placehold.co/600x400")}"
                                class="product_listItem--img"
                            >
                        </div>

                        <h3 class="product_listItem--title">${escapeHtml(name)}</h3>

                        <div class="product_listItem--cost">
